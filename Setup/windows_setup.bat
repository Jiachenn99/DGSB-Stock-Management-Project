...
IF ERRORLEVEL 0 (py -m pip install --upgrade pip & pip install virtualenv & echo Installed virtualenv)
IF ERRORLEVEL 1 (py get-pip.py && py -m pip install --upgrade pip & echo Installed pip)
